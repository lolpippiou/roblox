...
local CommandInfo = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/Stefanuk12/ROBLOX/master/Games/Kohls%20Admin%20House/Archive/oofkohlsv2/Data.json"));
local CommandsSpamPhrase = {};
local LongText = game:HttpGetAsync("https://github.com/Stefanuk12/ROBLOX/blob/master/Games/Kohls%20Admin%20House/Archive/LongText.txt");
